...
public class NewGUI extends GuiScreen {
           ...
           for (ModuleButton moduleButton : p.Elements) {
               ...
               if (moduleButton.isHovered(mouseX, mouseY)) {
                   if (NewGui.customfont.getValue()) {
                       Gui.drawRect((mouseX + 6), mouseY + 6, (mouseX + Xulu.cFontRenderer.getStringWidth(moduleButton.mod.getDesc()) + 11), (int)(mouseY + Xulu.cFontRenderer.getHeight() + 10), ColorUtils.changeAlpha(ColorUtils.Colors.BLACK, NewGui.bgAlpha.getValue()));
                       if (NewGui.outline.getValue()) XuluTessellator.drawRectOutline((mouseX + 6), mouseY + 6, (mouseX + Xulu.cFontRenderer.getStringWidth(moduleButton.mod.getDesc()) + 11), (int)(mouseY + Xulu.cFontRenderer.getHeight() + 10), 1,  ColorUtils.changeAlpha(ColorUtil.getClickGUIColor().getRGB(), 225));
                       ...
                       if (NewGui.outline.getValue()) XuluTessellator.drawRectOutline((mouseX + 6), mouseY + 6, (mouseX + Wrapper.getMinecraft().fontRenderer.getStringWidth(moduleButton.mod.getDesc()) + 11), (mouseY + Wrapper.getMinecraft().fontRenderer.FONT_HEIGHT + 10), 1, ColorUtils.changeAlpha(ColorUtil.getClickGUIColor().getRGB(), 225));
   ...
   public void initGui() {
        ...
        * Start blur
        */
       if (OpenGlHelper.shadersSupported && mc.getRenderViewEntity() instanceof EntityPlayer && NewGui.blur.getValue()) {
