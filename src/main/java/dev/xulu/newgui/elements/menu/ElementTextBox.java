...
public class ElementTextBox extends Element {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (listening) {
            ...
            if (showCursor)
                Gui.drawRect((int) x + (NewGui.customfont.getValue() ? Xulu.cFontRenderer.getStringWidth(s) : FontUtil.getStringWidth(s)) + 2, (int) y, (int) x + (NewGui.customfont.getValue() ? Xulu.cFontRenderer.getStringWidth(s) : FontUtil.getStringWidth(s)) + 3, (int) y + FontUtil.getFontHeight() + 2, -1);
        } else {
