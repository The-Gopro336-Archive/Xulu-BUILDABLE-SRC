...
public class ElementSlider extends Element {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		if (NewGui.sliderSetting.getValue().equalsIgnoreCase("Line")) {
			...
			boolean hoveredORdragged = (NewGui.sliderSetting.getValue().equalsIgnoreCase("Line") ? isSliderHovered(mouseX, mouseY) : isHovered(mouseX, mouseY)) || dragging;
	...
	public boolean mouseClicked(int mouseX, int mouseY, int mouseButton) {
		if (mouseButton == 0 && (NewGui.sliderSetting.getValue().equalsIgnoreCase("Line") ? isSliderHovered(mouseX, mouseY) : isHovered(mouseX, mouseY))) {
			this.dragging = true;
			return true;
		}
